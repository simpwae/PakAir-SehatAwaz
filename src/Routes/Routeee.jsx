...
const NationalDashboard = lazy(() =>
  import("../pages/official/NationalDashboard")
);
const ModelData = lazy(() => import("../pages/official/ModelData"));
const CitizenReports = lazy(() => import("../pages/official/CitizenReports"));
const PolicyAdvisory = lazy(() => import("../pages/official/PolicyAdvisory"));
...
const CitizenHealthGuidance = lazy(() =>
  import("../pages/citizen/HealthGuidance")
);
